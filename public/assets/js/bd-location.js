...
window.onload = function () {
  ...
  var divisionSel_permanent = document.getElementById("division_permanent");
  var districtSel_permanent = document.getElementById("district_permanent");
  var upazilaSel_permanent = document.getElementById("upazila_permanent");
  var form_type_permanent = document.getElementById("form_type_permanent").value;
  ...
  for (var x_dropdown_permanent in locationObject_dropdown) {
    divisionSel_permanent.options[divisionSel_permanent.options.length] = new Option(x_dropdown_permanent, x_dropdown_permanent);
  }
  if (form_type_permanent == 'EDIT') {
    divisionSel_permanent.onclick = function () {
      upazilaSel_permanent.length = 1;
      districtSel_permanent.length = 1;
      for (var y_dropdown in locationObject_dropdown[this.value]) {
        districtSel_permanent.options[districtSel_permanent.options.length] = new Option(y_dropdown, y_dropdown);
      }
    }
    districtSel_permanent.onclick = function () {
      upazilaSel_permanent.length = 1;
      var z_dropdown = locationObject_dropdown[divisionSel_permanent.value][this.value];
      for (var i = 0; i < z_dropdown.length; i++) {
        upazilaSel_permanent.options[upazilaSel_permanent.options.length] = new Option(z_dropdown[i], z_dropdown[i]);
      }
    }
  }
  else {
    divisionSel_permanent.onchange = function () {
      upazilaSel_permanent.length = 1;
      districtSel_permanent.length = 1;
      for (var y_dropdown in locationObject_dropdown[this.value]) {
        districtSel_permanent.options[districtSel_permanent.options.length] = new Option(y_dropdown, y_dropdown);
    ...
    districtSel_permanent.onchange = function () {
      upazilaSel_permanent.length = 1;
      var z_dropdown = locationObject_dropdown[divisionSel_permanent.value][this.value];
      for (var i = 0; i < z_dropdown.length; i++) {
        upazilaSel_permanent.options[upazilaSel_permanent.options.length] = new Option(z_dropdown[i], z_dropdown[i]);
