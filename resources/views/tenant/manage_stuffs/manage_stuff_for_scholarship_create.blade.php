        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12 mt-lg-4 mt-4">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h2 mb-0 text-gray-800 text-info font-weight-bold">Add Stuff For Scholarship Management</h1>
            ...
            <div class="col-md-12 mt-4">
                <div class="card card-body">
                    <form method="post" action="{{ route('manage_stuff1_store')}}">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <label for="name">Stuff Name<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="Enter Stuff Name" required>
                            </div>
