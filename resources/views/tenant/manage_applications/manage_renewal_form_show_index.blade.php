                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12 mt-lg-4 mt-4">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h2 mb-0 text-gray-800 text-info font-weight-bold">Renewal Form
                                </h1>
                ...
                <div class="card card-body">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            value="{{ $scholarship->id }}">{{ $scholarship->scholarship_title }}
                        </div> --}}
                        ...
                        <div class="row">
                            <div class="container-fluid">
                                <div class="form-group row">
                                    <label for="month_year" class="col-form-label col-sm-2">From Month<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control input-sm" id="fromDate" name="fromDate"
                                            placeholder="yyyy-mm-dd" required>
                                    </div>
                                    <label for="month_year" class="col-form-label col-sm-2">To Month<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-3">
